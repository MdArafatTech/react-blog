    ...
    <div className="p-8">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p>Answer: You can email us at <a className="text-red-500" href="mailto:maureen@cupofjo.com">maureen@cupofjo.com</a>.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>Answer: Please check  email <a className="text-red-500" href="mailto:mdalarafatabir@gmail.com">mdalarafatabir@gmail.com</a> for partnership opportunities.</p>
        </div>
      </div>
    </div>
  );
